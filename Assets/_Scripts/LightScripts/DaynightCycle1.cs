...
//    {
//        float intensity = intensityCurve.Evaluate(time / 720.0f); // 시간에 따른 강도 계산

//        lightSource.transform.eulerAngles = ((time / 720.0f) - (lightSource == sun ? 0.0025f : 0.0075f)) * noon * 0.4f;
//        lightSource.color = colorGradient.Evaluate(time / 720.0f);
...
//        timeText.text = "Day " + days + ", Time: " + hours.ToString("00") + ":" + minutes.ToString("00") + " " + daytime;
//    }
//}